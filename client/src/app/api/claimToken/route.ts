...
async function pollTransactionStatus(queueId: string, maxAttemps = 15, interval = 3000): Promise<boolean> {
...
export async function POST(request: Request) {
    ...
    const resp = await fetch(`${ENGINE_URL}/contract/84532/${tokenContractAddress}/erc20/mint-to`, {
        method: "POST",
        headers: {
